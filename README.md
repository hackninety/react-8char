...
- **十年规划表** - 一运一行人生总览：干支十神/十二长生/扶抑喜忌/K线总运均值/高光低谷年/该运格局 chips，点行展开逐年明细；随导出喂 AI（导出版不含 K线均值/高光低谷等量化列，防 AI 锚定误报）
- **能量多边形** - 宫位轴（事业官禄/财帛/子女才华/兄弟同侪/父母学业，婚姻随性别并入配偶星轴——八字对应紫微宫分类的六亲星映射）×「原局 → +大运 → +流年」层叠结构占比雷达（干支计点法），**总局/大限/流年三档范围切换**（总局=总命局原局能量），嵌在人生K线内随悬停联动，喜忌红绿着色（与引擎旺衰加权的五行力量互补两个口径）
